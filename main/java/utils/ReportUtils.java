...
public class ReportUtils {
	...
	public static void createMOPReport(String path, Id<ActivityFacility> id, String town,
		...
		FileUtils.appendToFile(path, "Raport z MOPa o nr " + id.toString() + ".\n");
		FileUtils.appendToFile(path, "Miejscowość: " + town + ".\n");
		FileUtils.appendToFile(path, "Nazwa (lub typ): " + name + ".\n");
		FileUtils.appendToFile(path, "Liczba miejsc parkingowych (samochody, pojazdy ciężarowe, autobusy): "
		+ carLimit +  ", " + truckLimit + ", " + busLimit + ".\n");
